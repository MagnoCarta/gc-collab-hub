//
//  SlideAnimationViewControllerInitial.swift
//  UIKitAnimation
//
...
class SlideAnimationViewControllerInitial: UIViewController {
...
#Preview {
    ViewControllerToPreview { SlideAnimationViewControllerInitial.self }
}
