...
class HorizontalSlideAnimationConstraintViewControllerInitial: UIViewController{
...
#Preview{
    ViewControllerToPreview { HorizontalSlideAnimationConstraintViewControllerInitial.self }
}
